...
DATABASES = {
	'default': {
		...
		# 'ENGINE': 'django.db.backends.sqlite3', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
		'NAME': os.path.dirname(os.path.abspath(__file__))+'/game.db',
		# 'USER': 'postgres',
		# 'PASSWORD': '111111',
		# 'HOST': 'gameserver',
		# 'PORT': '5432',
...
def datebase_is_pgsql():
	return DATABASES['default']['ENGINE'].find('postgresql_psycopg2')!=-1
...
WSGI_APPLICATION = 'model.django.desert.wsgi.application'
